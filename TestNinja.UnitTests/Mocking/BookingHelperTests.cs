...
namespace TestNinja.UnitTests.Mocking
{
	...
	public class BookingHelper_OverlappingBookingExistTests
	{
		...
		[Test]
		public void BookingStartAndFinishesInTheMiddleOfrAnExistingBooking_ReturnExistingBookingReference()
		{
			var result = BookingHelper.OverlappingBookingsExist(new Booking
			{
				Id = 1,
		...
		[Test]
		public void BookingStartInTheMiddleOfrAnExistingBookingButFinishesAfter_ReturnExistingBookingReference()
		{
			var result = BookingHelper.OverlappingBookingsExist(new Booking
			{
				Id = 1,
		...
		[Test]
		public void BookingStartAndFinishesAfterExistingBooking_ReturnEmptyString()
		{
			var result = BookingHelper.OverlappingBookingsExist(new Booking
			{
				Id = 1,
